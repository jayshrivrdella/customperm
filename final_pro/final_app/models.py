...
class UserManager(models.Manager):
    def create(self, email, password, name,roles):
        user = self.models(email=email, password=password,name=name,role = roles)
...
class UserRoleManager(models.Manager):
    def add(self,userid,role_id):
        user = self.models(u_id=userid,r_id=role_id)
        user.save(using=self._db)
